...
for nom in range(1,5):
    button2=InlineKeyboardButton(text=f'Product{nom}', callback_data='product_buying')
...
async def get_buying_list(message):
    for nom in range(1,5):
        with open(f'{nom}.png', 'rb') as img:
            await message.answer_photo(img, f'Название: Product{nom} | Описание: описание {nom} | Цена: {nom * 100}')
